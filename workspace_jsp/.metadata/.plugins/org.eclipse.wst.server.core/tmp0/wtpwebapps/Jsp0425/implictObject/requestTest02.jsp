...
2. getParameterValues() : 파라미터 변수에 저장된 변수값들을 얻는 메소드
...
7. getRequestURI() : 요청에 사용된 URI를 리턴
8. getRequestURL() : 요청에 사용된 URL을 리턴
9. getContextPath() : 컨텍스트 경로를 리턴
10. getRemoteHost() : 웹브라우저의 호스트 이름
11. getRemoteAddr() : 웹브라우저의 IP 주소
12. getServerPort() : 서버의 포트번호
...
접근 경로 : 프로젝트 명을 제외하고, 폴더명과 파일명을 포함한 경로
 --%>
...
<body>
	...
	<%
	String[] names = {"프로토콜 이름", "서버이름", "IP 주소", "포트번호", "메소드 방식", "URL", "URI", "컨텍스트 경로"};
