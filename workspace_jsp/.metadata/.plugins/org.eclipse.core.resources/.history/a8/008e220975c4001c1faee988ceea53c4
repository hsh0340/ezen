...
- 객체의 생성 없이 바로 사용할 수 있도록 JSP에서 미리 만들어 놓은 객체
- 9개의 내장객체
...
4. application 객체 - 웹 애플리케이션의 Context 정보를 저장하는 내장 객체
...
- application : 애플리케이션의 처리를 하는 영역
 ...
 <%--
 문제) 학번, 이름, 학년, 선택과목을 폼에서 입력하는 페이지와 결과를 출력하는 페이지를 생성하시오.
 - 해결시간 : 10분
 < 입력 페이지 설계 >
 - no, name, grade, subject
 - grade: 1학년, 2학년, 3학년, 4학년 -> radio
...
<body>
	...
	선택과목 :
	<select name="subject">
		<option value="HTML/CSS3">HTML/CSS3
